...
use graph_tally_aggregator::jsonrpsee_helpers;
...
use graph_tally_graph::{ReceiptAggregateVoucher, SignedRav, SignedReceipt};
use jsonrpsee::{
    core::async_trait,
...
async fn request_rav<E>(
    ...
    time_stamp_buffer: u64, // Buffer for timestamping, see graph_tally_core for details
    aggregator_client: &(HttpClient, String), // HttpClient for making requests to the graph_tally_aggregator server
    threshold: usize,
) -> Result<()>
where
