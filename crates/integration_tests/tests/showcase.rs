...
use graph_tally_graph::{Receipt, SignedRav, SignedReceipt};
use jsonrpsee::{
...
async fn test_manager_rav_timestamp_cutoff(
    ...
    // This test checks that graph_tally_core is correctly filtering receipts by timestamp.
    let (
        server_handle_1,
        socket_addr_1,
        _server_handle_2,
...
#[rstest]
#[tokio::test]
async fn test_graph_tally_aggregator_rav_timestamp_cuttoff(
    keys_sender: PrivateKeySigner,
    domain_separator: Eip712Domain,
    http_request_size_limit: u32,
    http_response_size_limit: u32,
    ...
    // This test checks that graph_tally_aggregator is correctly rejecting receipts with invalid timestamps
    ...
    // graph_tally_aggregator should reject the second RAV request due to the repeated timestamp.
    ...
    // graph_tally_aggregator should accept the second RAV request.
