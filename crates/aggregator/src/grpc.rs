...
/// Legacy uint128 module for backwards compatibility
pub mod uint128 {
...
/// Legacy v2 module for backwards compatibility with existing tap-agents.
/// New clients should use the `graph_tally` module instead.
#[deprecated(note = "Use graph_tally module instead")]
pub mod v2 {
    use anyhow::anyhow;
    use graph_tally_core::signed_message::Eip712SignedMessage;
    use thegraph_core::alloy::primitives::Bytes;
